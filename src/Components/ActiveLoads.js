...
//         const activeLoads = await axios.get("https://motionless-cowboy-hat-ant.cyclic.app/admin/allPostedLoads")
//         try {
    ...
    const getActiveLoads = async () => {
        ...
        try {
            if (activeLoadsResponse.data.TotalLoads !== 0) {
                const loads = activeLoadsResponse.data.loads;
    ...
    return (
        totalLoadsLength ? (
            ...
            <>
                ...
                <InputGroup className="mb-3" style={{ width: "20rem",marginLeft:'610px' }}>
                    <Form.Control
                        placeholder="Search"
                        value={searchKey}
                        onChange={(e) => setSearchKey(e.target.value)}
                ...
                <h3 style={{textAlign:'center',marginTop:'5px'}}>Posted Loads</h3>
                {isSearchCalled ? (
                                    ...
                                    {searchedResult.map((load, idx) => {
                                        ...
                                        return (
                                            ...
                                            <StyledTableCell align="right">
                                              ...
                                              <ActiveLoadsPopUp show={isClicked} onHide={() => setIsClicked(false)} />
                                            </StyledTableCell>
                                          </StyledTableRow>
                                    ...
                                    {filteredLoads.map((load, idx) => {
                                        ...
                                        return (
                                            <StyledTableRow key={load.name}>
                                                ...
                                                <StyledTableCell>{load.LoadId}</StyledTableCell>
                                                <StyledTableCell align="right">{load.UserName}</StyledTableCell>
